...
cat("Interpretación: En promedio, los países con alto PIB per cápita emiten",
    round(dif_media, 2),
    "toneladas más de CO₂ por persona que los de bajo PIB, lo que evidencia una diferencia sustancial en el comportamiento ambiental entre ambos grupos.\n")
